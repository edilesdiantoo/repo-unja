        ...
        <div class="card-body">
            <div class="row align-items-center g-4 mb-4">
                <div class="col-12">
                    ...
                    <p class="text-muted small mb-0">Seluruh data karya ilmiah civitas akademika yang telah terpublikasi
                        secara resmi.</p>
                </div>
            </div>
                ...
                <div class="col-12">
                    @if ($articles->isEmpty())
                        <div class="text-center py-5 text-muted fw-semibold border rounded-3 bg-light">
                            ...
                            <h5 class="fw-bold text-secondary mb-1">Koleksi Masih Kosong</h5>
                            <p class="small mb-0 text-muted">Belum ada karya ilmiah yang berstatus terpublikasi di sistem.
                            </p>
                        </div>
                    @else
